...
public class LocUtil {
    ...
    public LocUtil(Activity context) {
    ...
    private void createLocationCallback() {
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                SpUtils.getInstance().putString(ConfigValues.latitude, mCurrentLocation.getLatitude()+"");
                SpUtils.getInstance().putString(ConfigValues.longitude, mCurrentLocation.getLongitude()+"");
