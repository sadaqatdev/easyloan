...
class SelectItem1 extends StatefulWidget {
  final String title;
  ...
  SelectItem1(String this.defaultText,
      {Key? key,
      this.title = '',
      this.titleColor,
  ...
  @override
  State<SelectItem1> createState() => _SelectItem1State();
}

class _SelectItem1State extends State<SelectItem1> {
