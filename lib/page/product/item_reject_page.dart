...
class ProductRejectPage extends StatefulWidget {
  final ProductItem item;

  const ProductRejectPage({Key? key, required this.item}) : super(key: key);

  @override
  State<ProductRejectPage> createState() => _ProductRejectPageState();
}

class _ProductRejectPageState extends State<ProductRejectPage> {
  @override
