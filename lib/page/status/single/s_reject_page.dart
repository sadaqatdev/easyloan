...
class SRejectPage extends StatefulWidget {

  const SRejectPage({Key? key}) : super(key: key);

  @override
  State<SRejectPage> createState() => _SRejectPageState();
}

class _SRejectPageState extends State<SRejectPage> {
