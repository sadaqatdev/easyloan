...
class OrderLoanablePage extends StatefulWidget {
  final OrderItem item;

  const OrderLoanablePage({Key? key, required this.item}) : super(key: key);

  @override
  State<OrderLoanablePage> createState() => _OrderLoanablePageState();
}

class _OrderLoanablePageState extends State<OrderLoanablePage> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Image(image: AssetImage('images/ic_finish_ts.png'),
                          width: 32,height: 32,),

                        SizedBox(width: 5,),

                        Expanded(child: Text(
                          S.of(context).order_item_finish_hint,
                          style:
                  ...
                  Container(
                    ...
                    child: TextButton(
                        ...
                        child: Text(S.of(context).apply_again,
                            style: TextStyle(
